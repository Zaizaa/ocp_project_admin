...
export const IncidentMetrics = () => {
  ...
  return (
    <div className="grid grid-cols-4 gap-4 md:gap-6">
      ...
      <div
        className={`rounded-2xl border border-gray-200 p-5 md:p-6 transition-all duration-300 cursor-pointer ${colorMap[ticketType].bgBlock} ${colorMap[ticketType].hover} hover:shadow-md`}
      >
      ...
      {/* Autres cartes */}
      <div className="rounded-2xl border border-gray-200 bg-white p-5 md:p-6 hover:bg-green-50 hover:shadow-md transition-all duration-300 cursor-pointer">
